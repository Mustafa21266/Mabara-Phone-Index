...
exports.editDepartment = async (req, res, next) => {
    ...
    if (!user || user.role !== 'admin') {
        ...
        let department = await Department.findByIdAndUpdate(req.params.id, newData, {
            new: true,
            runValidators: true,
        ...
        res.status(200).json({
                    success: true,
                    message: 'Department Editied Successfully!',
                    department
                })
        }
...
//             {
//                 folder: `dadswebdepartment/articles/images`
//             },
