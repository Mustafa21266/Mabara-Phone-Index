...
exports.createFloor = async (req, res, next) => {
    ...
    if (!user || user.role !== 'admin') {
        ...
        let floor = await Floor.create(req.body)
...
exports.editFloor = async (req, res, next) => {
    ...
    if (!user || user.role !== 'admin') {
        ...
        let floor = await Floor.findByIdAndUpdate(req.params.id, newData, {
            new: true,
            runValidators: true,
        ...
        res.status(200).json({
                    success: true,
                    message: 'Floor Editied Successfully!',
                    floor
                })
        }
...
//             {
//                 folder: `dadswebfloor/articles/images`
//             },
