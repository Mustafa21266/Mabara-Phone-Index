  ...
  componentDidMount() {
    setTimeout(async () => {
      this.setState((state, props) => {
        ...
        .getState()
        .department.departments.filter(department => department.site === "68cbbdf4c5b33217c021870e"),
        userPins: store
        .getState()
        ...
        .getState()
        .department.departments.filter(department => department.site === "68cbbdf4c5b33217c021870e")[0]._id)
        };
      });
