...
class OPCapitalDashboard extends Component {
  constructor(props) {
    super(props);
    this.state = {
      users: [],
          ...
          store.dispatch(getAllFloors()).then(async (floorsData) => {
            store.dispatch(getAllExtensions()).then(async (extensionsData) => {
              ...
              this.setState({
                ...
                sites: sitesData.filter((site) => site._id === "68cbbdf4c5b33217c021870e"),
                floors: floorsData.filter((floor) => floor.site === "68cbbdf4c5b33217c021870e"),
                extensions: extensionsData.filter((ext) => ext.site === "68cbbdf4c5b33217c021870e"),
                loading: false,
              });
            })
        })
...
export default withRouter(OPCapitalDashboard);
