...
class SharkHomepage extends Component {
  constructor(props) {
    super(props);
    this.state = {
      pinDeleted: false,
    ...
    setTimeout(async () => {
      this.setState((state, props) => {
        return {
          ...
          extensions: store
        .getState()
        .extension.extensions.filter(ext => ext.site === "68cbbe05c5b33217c0218714" && ext.floor === "68d8f3d381a82156c883e3d4"),
